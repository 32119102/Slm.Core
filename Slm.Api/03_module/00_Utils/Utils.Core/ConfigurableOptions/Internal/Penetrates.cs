...
using Slm.Utils.Core.ConfigurableOptions.Attributes;
...
namespace Slm.Utils.Core.ConfigurableOptions.Internal;
...
internal static class Penetrates
{
    ...
    {
        if (App.ServiceProvider == null && typeof(IConfigurableOptions).IsAssignableFrom(typeof(TOptions)))
        {
